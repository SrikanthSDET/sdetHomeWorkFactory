...
public class RetriveIncident extends BaseClass{
	@Test (dependsOnMethods = "jira.CreateIncident.createIncidentInJira")
	public void retriveIncidentJira() {
